    ...
    <section id="contato" style={{ backgroundColor: '#F3E8DA' }} className="py-24 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: '#6B4530' }}>
          Vamos <span style={{ color: '#D98C5A' }}>conversar?</span>
        </h2>
        ...
        <a
          ...
          className="inline-flex items-center gap-3 font-semibold px-8 py-4 rounded-xl transition hover:opacity-90"
          style={{ backgroundColor: '#EDD9BC', color: '#6B4530' }}
        >
          <svg className="w-5 h-5" fill="#6B4530" viewBox="0 0 32 32">
